...
public:
	...
	double priceAsian(BlackScholesModel const& model, AsianArithmetic const& option);
	void priceAndShowAsian(BlackScholesModel const& model, AsianArithmetic const& option);
	void showPrices();
